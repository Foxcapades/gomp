...
type MapUintUint32 interface {
	...
	SerializeOrdered(bool) MapUintUint32
}

// MapUintUint32Entry is a single entry in an instance of
// MapUintUint32.
...
// NewMapUintUint32 creates a new instance of MapUintUint32 presized to the
// given size.
...
func (i *implMapUintUint32) SerializeOrdered(b bool) MapUintUint32 {
	i.outOrder = b
	return i
}
