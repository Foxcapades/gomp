...
// MapAnyUint16Entry is a single entry in an instance of
// MapAnyUint16.
...
// NewMapAnyUint16 creates a new instance of MapAnyUint16 presized to the
// given size.
...
func (i *implMapAnyUint16) SerializeOrdered(b bool) MapAnyUint16 {
	i.outOrder = b
	return i
}
