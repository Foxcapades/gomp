...
type MapStringUint interface {
	...
	SerializeOrdered(bool) MapStringUint
}

// MapStringUintEntry is a single entry in an instance of
// MapStringUint.
...
// NewMapStringUint creates a new instance of MapStringUint presized to the
// given size.
...
func (i *implMapStringUint) SerializeOrdered(b bool) MapStringUint {
	i.outOrder = b
	return i
}
