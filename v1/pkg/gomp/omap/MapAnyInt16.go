...
// MapAnyInt16Entry is a single entry in an instance of
// MapAnyInt16.
...
// NewMapAnyInt16 creates a new instance of MapAnyInt16 presized to the
// given size.
func NewMapAnyInt16(size int) MapAnyInt16 {
	return &implMapAnyInt16{
		ordered:  make([]MapAnyInt16Entry, 0, size),
		index:    make(map[interface{}]int16, size),
		outOrder: true,
	}
}

// MapAnyInt16 is an ordered map interface{} to int16.
type implMapAnyInt16 struct {
	ordered  []MapAnyInt16Entry
	index    map[interface{}]int16
	outOrder bool
}

func (i implMapAnyInt16) MarshalYAML() (interface{}, error) {
	return i.ToYAML()
}

func (i implMapAnyInt16) MarshalJSON() ([]byte, error) {
	if i.outOrder {
...
func (i *implMapAnyInt16) ToYAML() (*yaml.Node, error) {
	if i.outOrder {
...
func (i *implMapAnyInt16) Put(k interface{}, v int16) MapAnyInt16 {
	i.Delete(k)
	i.index[k] = v
	i.ordered = append(i.ordered, MapAnyInt16Entry{k, v})
	return i
}

func (i *implMapAnyInt16) PutIfNotNil(k interface{}, v *int16) MapAnyInt16 {
	if !gomp.IsNil(v) {
		return i.Put(k, *v)
	}
...
func (i *implMapAnyInt16) ReplaceOrPut(k interface{}, v int16) MapAnyInt16 {
	if i.Has(k) {
...
func (i *implMapAnyInt16) ReplaceIfExists(k interface{}, v int16) MapAnyInt16 {
	pos := i.IndexOf(k)
...
func (i *implMapAnyInt16) Get(k interface{}) (value int16, exists bool) {
	v, ok := i.index[k]
	return v, ok
}

func (i *implMapAnyInt16) GetOpt(k interface{}) option.Int16 {
...
func (i *implMapAnyInt16) At(j int) MapAnyInt16Entry {
	return i.ordered[j]
}

func (i *implMapAnyInt16) Len() int {
	return len(i.ordered)
}

func (i *implMapAnyInt16) Has(k interface{}) bool {
	_, ok := i.index[k]
	return ok
}

func (i *implMapAnyInt16) IndexOf(k interface{}) int {
...
func (i *implMapAnyInt16) Delete(k interface{}) MapAnyInt16 {
	pos := i.IndexOf(k)
...
func (i *implMapAnyInt16) ForEach(f func(k interface{}, v int16)) MapAnyInt16 {
	for j := range i.ordered {
...
func (i *implMapAnyInt16) SerializeOrdered(b bool) MapAnyInt16 {
	i.outOrder = b
	return i
}
