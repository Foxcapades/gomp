...
// MapIntUint64Entry is a single entry in an instance of
// MapIntUint64.
...
// NewMapIntUint64 creates a new instance of MapIntUint64 presized to the
// given size.
...
func (i *implMapIntUint64) SerializeOrdered(b bool) MapIntUint64 {
	i.outOrder = b
	return i
}
