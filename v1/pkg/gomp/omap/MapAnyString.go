...
// MapAnyStringEntry is a single entry in an instance of
// MapAnyString.
...
// NewMapAnyString creates a new instance of MapAnyString presized to the
// given size.
func NewMapAnyString(size int) MapAnyString {
	return &implMapAnyString{
		ordered:  make([]MapAnyStringEntry, 0, size),
		index:    make(map[interface{}]string, size),
		outOrder: true,
	}
}

// MapAnyString is an ordered map interface{} to string.
type implMapAnyString struct {
	ordered  []MapAnyStringEntry
	index    map[interface{}]string
	outOrder bool
}

func (i implMapAnyString) MarshalYAML() (interface{}, error) {
	return i.ToYAML()
}

func (i implMapAnyString) MarshalJSON() ([]byte, error) {
	if i.outOrder {
...
func (i *implMapAnyString) ToYAML() (*yaml.Node, error) {
	if i.outOrder {
...
func (i *implMapAnyString) Put(k interface{}, v string) MapAnyString {
	i.Delete(k)
	i.index[k] = v
	i.ordered = append(i.ordered, MapAnyStringEntry{k, v})
	return i
}

func (i *implMapAnyString) PutIfNotNil(k interface{}, v *string) MapAnyString {
	if !gomp.IsNil(v) {
		return i.Put(k, *v)
	}
...
func (i *implMapAnyString) ReplaceOrPut(k interface{}, v string) MapAnyString {
	if i.Has(k) {
...
func (i *implMapAnyString) ReplaceIfExists(k interface{}, v string) MapAnyString {
	pos := i.IndexOf(k)
...
func (i *implMapAnyString) Get(k interface{}) (value string, exists bool) {
	v, ok := i.index[k]
	return v, ok
}

func (i *implMapAnyString) GetOpt(k interface{}) option.String {
...
func (i *implMapAnyString) At(j int) MapAnyStringEntry {
	return i.ordered[j]
}

func (i *implMapAnyString) Len() int {
	return len(i.ordered)
}

func (i *implMapAnyString) Has(k interface{}) bool {
	_, ok := i.index[k]
	return ok
}

func (i *implMapAnyString) IndexOf(k interface{}) int {
...
func (i *implMapAnyString) Delete(k interface{}) MapAnyString {
	pos := i.IndexOf(k)
...
func (i *implMapAnyString) ForEach(f func(k interface{}, v string)) MapAnyString {
	for j := range i.ordered {
...
func (i *implMapAnyString) SerializeOrdered(b bool) MapAnyString {
	i.outOrder = b
	return i
}
