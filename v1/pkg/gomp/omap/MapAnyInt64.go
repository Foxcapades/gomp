...
// MapAnyInt64Entry is a single entry in an instance of
// MapAnyInt64.
...
// NewMapAnyInt64 creates a new instance of MapAnyInt64 presized to the
// given size.
...
func (i *implMapAnyInt64) SerializeOrdered(b bool) MapAnyInt64 {
	i.outOrder = b
	return i
}
