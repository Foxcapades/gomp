...
type MapStringUint16 interface {
	...
	SerializeOrdered(bool) MapStringUint16
}

// MapStringUint16Entry is a single entry in an instance of
// MapStringUint16.
...
// NewMapStringUint16 creates a new instance of MapStringUint16 presized to the
// given size.
...
func (i *implMapStringUint16) SerializeOrdered(b bool) MapStringUint16 {
	i.outOrder = b
	return i
}
